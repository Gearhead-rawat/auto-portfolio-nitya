        ...
        <div className="w-full md:w-1/2 md:pr-12 z-10">
          <div className="reveal">
            <span className="inline-block mb-3 py-1 px-3 rounded-full bg-dark-700 text-accent-blue text-sm font-mono tracking-wider">
              Automotive & Aeronautical Engineer
            </span>
            <h1 className="mb-4 font-display font-bold">
              Future<br />
              <span className="text-gradient glow-text">Engineering</span><br />
              Innovation
            </h1>
            <p className="text-dark-100 text-lg mb-8 max-w-lg">
              Pioneering the future of mobility with precision engineering and cutting-edge aerospace technologies.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                View My Work <Rocket className="ml-2 h-5 w-5" />
              </Button>
              <Button 
                variant="outline" 
                size="lg" 
